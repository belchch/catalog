...
| 03 | Агент-луп (function-calling цикл, реестр инструментов, trace) | Done | [step-03-agent-loop.md](step-03-agent-loop.md) |
| 04 | Хранилище + инструменты документов (FS, SQLite, ingest, list/read) | Done | [step-04-storage-documents.md](step-04-storage-documents.md) |
| 05 | verify + apply_skill (реестр проверок, retry, результат=Document) | Done | [step-05-verify-apply.md](step-05-verify-apply.md) |
| 06 | Backend API (FastAPI: documents, planner WS, skill build/commit/apply, run streaming) | Done | [step-06-backend-api.md](step-06-backend-api.md) |
| 07 | UI (React: чат-планировщик, доки, создать/коммит/применить, результат + стриминг) | Done | [step-07-ui.md](step-07-ui.md) |
| 08 | Золотой прогон + полировка | Done | [step-08-golden-polish.md](step-08-golden-polish.md) |
